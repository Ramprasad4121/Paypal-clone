...
contract Paypal {
    ...
    function payRequest(uint256 _request) public payable {
        ...
        myRequests[_request] = myRequests[myRequests.length - 11];
        myRequests.pop();
    }
    ...
    function addHistory(
        ...
        newSend.otherPaymentAddress = receiver;
        ...
        newReceive.otherPaymentAddress = sender;
